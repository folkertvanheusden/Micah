...
void eval_par::set_eval(const std::string & name, int value)
{
	...
	else if (name == tune_mobility.name())
		tune_mobility.set_value(value);
	else if (name == tune_double_pawns.name())
		tune_double_pawns.set_value(value);
	else if (name == tune_king_attacks.name())
		tune_king_attacks.set_value(value);
	...
	else if (name == tune_king.name())
		tune_king.set_value(value);
	else if (name == tune_find_forks.name())
		tune_find_forks.set_value(value);
	else if (name == tune_king_shield.name())
		tune_king_shield.set_value(value);
	else if (name == tune_development.name())
		tune_development.set_value(value);
