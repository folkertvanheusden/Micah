...
{
	int values[] = { parameters.tune_pawn.value(), parameters.tune_knight.value(), parameters.tune_bishop.value(), parameters.tune_rook.value(), parameters.tune_queen.value(), parameters.tune_king.value() };
